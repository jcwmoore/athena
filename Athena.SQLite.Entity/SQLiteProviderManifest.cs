...
namespace System.Data.SQLite
{
	...
	internal class SQLiteProviderManifest : DbXmlEnabledProviderManifest
	{
		...
		{
			return GetXmlResource("System.Data.SQLite.Entity.Resources.SQLiteProviderServices.ProviderManifest.xml");
		}
				...
				case PrimitiveTypeKind.String: // char, nchar, varchar, nvarchar, varchar(max), nvarchar(max), ntext, text
					{
						...
						TypeUsage tu;// = TypeUsage.CreateStringTypeUsage(StoreTypeNameToEdmPrimitiveType["nvarchar"], true, false, maxLength);
		...
		{
			return GetXmlResource("System.Data.SQLite.Entity.Resources.SQLiteProviderServices.StoreSchemaMapping.msl");
		}

		private XmlReader GetStoreSchemaDescription()
		{
			return GetXmlResource("System.Data.SQLite.Entity.Resources.SQLiteProviderServices.StoreSchemaDefinition.ssdl");
		}

		internal static XmlReader GetXmlResource(string resourceName)
		{
			Assembly executingAssembly = Assembly.GetAssembly(typeof(SQLiteProviderManifest));
