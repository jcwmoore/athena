...
namespace IoC
{
    public static class WeakSingletonLifeCycleExtensions
    {
        ...
        /// </summary>
        public static void AsWeakSingleton<TInterface, TImplementation>(this IoCRegistration<TInterface, TImplementation> jr) where TImplementation : class, TInterface
        {
        ...
        /// </summary>
        public static void AsWeakSingleton<TInterface, TImplementation>(this IoCRegistration<TInterface, TImplementation> jr, TImplementation def) where TImplementation : class, TInterface
        {
            jr.ResolutionInfo.LifeCycleManager = new WeakSingletonLifecycle<TInterface, TImplementation>(jr.ResolutionInfo, def);
        }

        internal class WeakSingletonLifecycle<TInterface, TImplementation> : IIoCLifeCycleManager<TInterface> where TImplementation : class, TInterface
        {
